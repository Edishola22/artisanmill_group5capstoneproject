...
class __$$_successCopyWithImpl<T, $Res>
    extends _$ChatStateCopyWithImpl<T, $Res, _$_success<T>>
...
abstract class _success<T> implements ChatState<T> {
...
class __$$_errorCopyWithImpl<T, $Res>
    extends _$ChatStateCopyWithImpl<T, $Res, _$_error<T>>
...
abstract class _error<T> implements ChatState<T> {
